...
/**
 * This is an example of how to use the DpI2CEEPROM2 class.  It writes a big block of
...
// One EEPROM connected on address '50'
...
void setup(void)
{
  ...
  Serial.println("DpI2CEEPROM2/examples/readwrite/");

  // Write a really large chunk to a certain location on the EEPROM,
  // and see how long it takes
  unsigned long start_time = millis();
  EP.write(eeprom_write_location,sample_data,sample_data_len);
...
void loop()
{
  ...
  EP.read(current_read_location,buffer,bytes_read);
